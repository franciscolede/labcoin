<template>
    <div class="footer">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col title">LABCOIN</div>
                <div class="col"><img style="height: 50px;" src="@/assets/logo.png" alt="logo"></div>
                <div class="col">Compra y venta de cripto</div>
        ...
        <div class="row soporte">
            <div class="col col-sop">
                ...
                <div>franciscolede01@gmail.com</div>
            </div>
            <div class="col col-sop">
